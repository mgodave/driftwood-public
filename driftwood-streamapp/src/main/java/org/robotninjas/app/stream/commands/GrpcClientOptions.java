...
public class GrpcClientOptions {
  ...
  public GrpcClientOptions usePlaintext(boolean ignore) {
    builder.add(ManagedChannelBuilder::usePlaintext);
    return this;
  }

  @Option(names = {"--transport-security"})
  public GrpcClientOptions useTransportSecurity(boolean ignore) {
    builder.add(ManagedChannelBuilder::useTransportSecurity);
    return this;
  }

  @Option(names = {"--full-stream-decompression"}, split = ",", defaultValue = "None")
  public GrpcClientOptions enableFullStreamDecompression(List<GrpcCompressionCodec> codecs) {
    builder.add(builder -> {
  ...
  public GrpcClientOptions withIdleTimeout(long idleTimeout) {
    builder.add(builder ->
  ...
  public GrpcClientOptions withMaxInboundMessageSize(int maxInboundMessageSize) {
    builder.add(builder ->
  ...
  public GrpcClientOptions withMaxInboundMetadataSize(int maxInboundMetadataSize) {
    builder.add(builder ->
  ...
  public GrpcClientOptions withKeepAliveTime(long keepAliveTime) {
    builder.add(builder ->
  ...
  public GrpcClientOptions withKeepAliveTimeout(long keepAliveTimeout) {
    builder.add(builder ->
  ...
  public GrpcClientOptions keepAliveWithoutCalls(boolean keepAliveWithoutCalls) {
    builder.add(builder ->
  ...
  public GrpcClientOptions withMaxRetryAttempts(int maxRetryAttempts) {
    builder.add(builder ->
  ...
  public GrpcClientOptions withMaxHedgedAttempts(int maxHedgedAttempts) {
    builder.add(builder ->
  ...
  public GrpcClientOptions withRetryBufferSize(long retryBufferSize) {
    builder.add(builder ->
  ...
  public GrpcClientOptions withPerRpcBufferLimit(long perRpcBufferLimit) {
    builder.add(builder ->
  ...
  @Option(names = {"--retry"})
  public GrpcClientOptions retry(boolean ignore) {
  ...
  public static GrpcClientOptions builder(String target) {
    return new GrpcClientOptions(target);
  }
